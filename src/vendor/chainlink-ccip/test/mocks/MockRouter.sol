...
contract MockCCIPRouter is IRouter, IRouterClient {
    ...
    mapping(address instance => uint64 chainSelector) s_instanceToChainSelector;
        ...
        returns (bytes32)
    {
        ...
        Client.Any2EVMMessage memory executableMsg = Client.Any2EVMMessage({
            messageId: mockMsgId,
            sourceChainSelector: s_instanceToChainSelector[msg.sender],
    ...
    function setInstanceToChainSelector(address instance, uint64 chainSelector) external {
        s_instanceToChainSelector[instance] = chainSelector;
    }
}
